...
export class MissionService {
  ...
  getMissionThemeList(): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}${API_ENDPOINTS.COMMON.MISSION_THEME_LIST}`)
  }

  getMissionSkillList(): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}${API_ENDPOINTS.COMMON.MISSION_SKILL_LIST}`)
  }
